...
import { Shield, ChevronRight, Lock, Zap, Eye, Binary, Music, Target, Sparkles, Trash2 } from 'lucide-react';
...
const MissionCard: React.FC<MissionCardProps> = ({ mission, t, onSelect, onDelete }) => {
